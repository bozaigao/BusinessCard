...
import styles, { absL, absT, bdColor, bgColor, bo, color, commonStyles, fSize, h, ma, ml, mt, radiusA, w, wRatio } from "../../../utils/style";
let Card = class Card extends PureComponent {
  render() {
    return <View style={styleAssign([wRatio(100), styles.uac])}>
          <View style={styleAssign([wRatio(95), h(204), bgColor('rgb(211,199,195)'), radiusA(10), styles.udr, styles.uje])}>
            <Image style={styleAssign([wRatio(100), h(204), radiusA(10), styles.upa, absL(0), absT(0)])} src={require('../../../assets/ico_default.jpeg')} />
            <View style={styleAssign([ma(20)])}>
              <View style={styleAssign([styles.uac, styles.udr])}>
                <Text style={styleAssign([fSize(18)])}>王嘉怡</Text>
                <Text style={styleAssign([fSize(12)])}>销售经理</Text>
              </View>
              <Text style={styleAssign([fSize(12), mt(30), mt(5)])}>15982468866@qq.com</Text>
              <Text style={styleAssign([fSize(12), mt(5)])}>{`四川省成都市武侯区盛和\n二路18号富森美家居`}</Text>
            </View>
          </View>
          
          <View style={styleAssign([wRatio(100), h(204), bgColor(commonStyles.whiteColor), styles.uac, mt(20)])}>
            <View style={styleAssign([wRatio(100), styles.uac, styles.udr, h(60), bgColor(commonStyles.whiteColor)])}>
            ...
            <View style={styleAssign([wRatio(95), styles.uac, styles.udr, h(44), bgColor(commonStyles.whiteColor)])}>
              <View style={styleAssign([wRatio(100), styles.udr, styles.uac])}>
                <View style={styleAssign([styles.uf1, radiusA(4), styles.uac, styles.ujc, bo(5), bdColor(commonStyles.redColor), bgColor(commonStyles.whiteColor), h(44)])}>
                  <Text style={styleAssign([fSize(14), color(commonStyles.colorTheme)])}>完善名片</Text>
                </View>
                <View style={styleAssign([styles.uf1, radiusA(4), ml(15), styles.uac, styles.ujc, bo(1), h(44), bdColor(commonStyles.colorTheme), bgColor(commonStyles.blackColor), bo(5), bdColor('red')])}>
                  <Text style={styleAssign([fSize(14), color(commonStyles.whiteColor)])}>分享名片</Text>
                </View>
              </View>
            </View>
            
            <View style={styleAssign([wRatio(95), styles.uac, styles.udr, h(100), bgColor(commonStyles.whiteColor)])}>
