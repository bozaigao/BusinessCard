    ...
    render() {
        ...
        <components_1.View style={datatool_1.styleAssign([style_1.default.uac, style_1.default.udr, style_1.ml(20), style_1.mt(32)])}>
          ...
          <components_1.View style={datatool_1.styleAssign([style_1.default.uf1, style_1.default.udr, style_1.default.uac, style_1.default.ujb])}>
            ...
            <components_1.View style={datatool_1.styleAssign([style_1.w(40), style_1.h(40), style_1.default.uac, style_1.default.ujc])} onClick={() => {
            goToMoreGoods();
        }}>
        ...
        <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.mt(16)])}>
          {listData.map((value, index) => {
            console.log(value);
            return (<index_1.default onClick={() => {
                goToGoodsDetail(value);
            }} customStyle={datatool_1.styleAssign([style_1.wRatio(90), style_1.default.udr, style_1.default.uac, { marginLeft: '5%' }, style_1.mt(10), style_1.h(152), style_1.pa(8), style_1.bgColor(style_1.commonStyles.whiteColor)])} key={index}>
                  <components_1.Image style={datatool_1.styleAssign([style_1.w(120), style_1.h(120), style_1.radiusA(4)])} src={value.carouselUrl ? datatool_1.parseData(value.carouselUrl)[0] : ''} onClick={(e) => {
                e.stopPropagation();
                goToGoodsDetail(value);
            }}/>
