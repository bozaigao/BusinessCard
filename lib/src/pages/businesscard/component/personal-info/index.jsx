...
class PersonalInfo extends taro_1.PureComponent {
    ...
    render() {
        ...
        <components_1.View style={datatool_1.styleAssign([style_1.wRatio(95), style_1.bgColor(style_1.commonStyles.whiteColor), style_1.radiusA(4),
          ...
          {userInfo.selfDescription.length !== 0 && <multi_line_text_1.default style={datatool_1.styleAssign([style_1.fSize(14), style_1.color('#343434'), style_1.mt(16)])} text={userInfo.selfDescription}/>}
          ...
          {(userInfo.hometownProvince.length !== 0 || userInfo.hometownCity.length !== 0) &&
            <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.default.udr, style_1.default.uac, style_1.default.ujb, style_1.mt(24)])}>
              <components_1.View>
                ...
                <components_1.Text style={datatool_1.styleAssign([style_1.fSize(12)])}>{`${userInfo.hometownProvince} ${userInfo.hometownCity}`}</components_1.Text>
              </components_1.View>
              <components_1.View style={datatool_1.styleAssign([style_1.w(52), style_1.h(28), style_1.radiusA(4), style_1.default.uac, style_1.default.ujc,
                style_1.bo(1), style_1.radiusA(4), { borderStyle: 'solid' }, style_1.bdColor(style_1.commonStyles.colorTheme), style_1.mr(16)])} onClick={() => {
                homeClick();
          ...
          {userInfo.school.length !== 0 &&
            <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.default.udr, style_1.default.uac, style_1.default.ujb, style_1.mt(24)])}>
              <components_1.View style={datatool_1.styleAssign([])}>
                ...
                <components_1.Text style={datatool_1.styleAssign([style_1.fSize(10), style_1.color('#979797')])}>{`${userInfo.profession}`}</components_1.Text>}
              </components_1.View>
              <components_1.View style={datatool_1.styleAssign([style_1.w(52), style_1.h(28), style_1.radiusA(4), style_1.default.uac, style_1.default.ujc,
                style_1.bo(1), style_1.radiusA(4), { borderStyle: 'solid' }, style_1.bdColor(style_1.commonStyles.colorTheme), style_1.mr(16)])} onClick={() => {
                schoolClick();
