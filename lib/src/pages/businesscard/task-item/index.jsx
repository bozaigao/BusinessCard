    ...
    render() {
        ...
        <components_1.View style={datatool_1.styleAssign([style_1.w(335), style_1.h(153), style_1.bgColor(style_1.commonStyles.whiteColor), style_1.radiusA(4)])}>
          <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.default.uac, style_1.default.udr, style_1.default.ujb,
            ...
            <components_1.Text style={datatool_1.styleAssign([style_1.fSize(16), style_1.color('#343434')])}>对客户进行电话回访</components_1.Text>
          ...
          <components_1.Text style={datatool_1.styleAssign([style_1.fSize(10), style_1.color('#A6A6A6'), style_1.mt(4), style_1.ml(20)])}>2019-11-20 09:22</components_1.Text>
          <components_1.Text style={datatool_1.styleAssign([style_1.fSize(12), style_1.color('#343434'), style_1.mt(10), style_1.ml(20)])}>她对产品非常有兴趣，但对价格有些犹豫</components_1.Text>
