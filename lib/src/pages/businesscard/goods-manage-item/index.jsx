...
class GoodsManageItem extends taro_1.PureComponent {
    render() {
        ...
        return (<touchable_button_1.default customStyle={datatool_1.styleAssign([style_1.wRatio(100), style_1.h(189), style_1.bgColor(style_1.commonStyles.whiteColor), style_1.mt(10)])} onClick={() => {
        ...
        <components_1.View style={datatool_1.styleAssign([style_1.default.uac, style_1.default.udr, style_1.ml(20), style_1.mt(16)])}>
          <components_1.View style={datatool_1.styleAssign([style_1.w(90), style_1.h(90)])}>
            ...
            {itemData.showHomepage === 1 && <components_1.Image style={datatool_1.styleAssign([style_1.w(36), style_1.h(36), style_1.default.upa, style_1.absL(0), style_1.absT(0)])} src={require('../../../assets/ico_top.png')}/>}
          </components_1.View>
