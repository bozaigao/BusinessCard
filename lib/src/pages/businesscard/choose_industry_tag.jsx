...
let ChooseIndustryTag = class ChooseIndustryTag extends taro_1.Component {
    constructor(props) {
        super(props);
        /**
    ...
    render() {
        ...
        <components_1.ScrollView style={datatool_1.styleAssign([style_1.default.uf1, style_1.mt(30), style_1.default.uac, style_1.bgColor(style_1.commonStyles.whiteColor)])} scrollY>
          <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.default.uWrap, style_1.default.udr, style_1.default.uac, style_1.default.uja, style_1.pl(20), style_1.pr(20)])}>
            ...
            }} key={index} style={datatool_1.styleAssign([style_1.default.uac, style_1.default.ujc, style_1.padding([9, 35, 9, 35]), style_1.radiusA(20), style_1.mt(20), style_1.ml(20), style_1.bo(1),
                { borderStyle: 'solid', }, style_1.bdColor(chooseValue.includes(value.name) ? style_1.commonStyles.colorTheme : 'rgb(229,229,229)'), style_1.ml(index % 3 === 0 ? 0 : 23)])}>
...
ChooseIndustryTag = __decorate([
    redux_1.connect(state => state.login, Object.assign(actions, dictActions))
], ChooseIndustryTag);
exports.default = ChooseIndustryTag;
//# sourceMappingURL=choose_industry_tag.jsx.map
