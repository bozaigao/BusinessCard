    ...
    render() {
        ...
        <components_1.View style={datatool_1.styleAssign([style_1.default.uWrap, style_1.default.udr, style_1.default.uja, style_1.wRatio(100), style_1.mt(16)])}>
          {[1, 2, 3, 4].map((value, index) => {
            console.log(value);
            return (<components_1.View style={datatool_1.styleAssign([style_1.w(163), style_1.h(233), style_1.pa(8), style_1.bgColor(style_1.commonStyles.whiteColor)])} key={index}>
