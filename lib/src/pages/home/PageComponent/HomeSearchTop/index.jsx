 ...
 * @Description: 首页搜索栏
 */
// import {Navigation} from 'react-navigation_bar';
    ...
    render() {
        ...
        <components_1.View className='home__search-xinfeng'>
          <components_1.Button onClick={() => {
            console.log('点击我了哈哈');
            // navigation_bar.navigate('MessagePage')
        }}>
        ...
        <components_1.View>
          <components_1.Button onClick={() => {
            // navigation_bar.navigate('SearchPage')
        }}>
        ...
        <components_1.View>
          <components_1.Button onClick={() => {
            console.log('记录');
            // navigation_bar.navigate('LookHistoryPage')
        }}>
