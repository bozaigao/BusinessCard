...
let Introduce = class Introduce extends taro_1.Component {
    ...
    render() {
      ...
      <index_2.default />
        <components_1.Text style={datatool_1.styleAssign([style_1.ml(20), style_1.mr(20), style_1.mt(15), style_1.color('#727272'), style_1.fSize(14)])}>“极易推”作为一款智能名片小程序，不满足于作为简单的名片管理工具，更立志于提升每一位用户的商业价值，在集创建、收发、管理名片为一体的基础上，开发了线上商城以及分销模式，让用户不仅能销售自己的产品和服务，还能代理“极易推”小程序，为自己创造商机。\n
          ...
          在人脉机遇中，“极易推”不仅可以根据用户所完善的名片信息为每一位用户推送匹配人脉，而且可以通过让用户自己选择期望人脉类型，从而为用户推送更精准的人脉，成功解决了销售行业获客难得问题。</components_1.Text>
      </index_1.default>);
    }
};
