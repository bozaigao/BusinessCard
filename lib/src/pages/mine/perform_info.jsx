...
const index_3 = require("../../compoments/linear-gradient-view2/index");
...
let PerformInfo = class PerformInfo extends taro_1.Component {
        ...
        this.getUserInfo = () => {
            this.props.getUserInfo().then((res) => {
                if (res) {
                    ...
                    this.setState({ photoUrl: res.photoUrl ? datatool_1.parseData(res.photoUrl) : [], videoUrl: res.videoUrl }, () => {
    ...
    render() {
        ...
        <components_1.ScrollView style={datatool_1.styleAssign([style_1.wRatio(100), style_1.hRatio(100), style_1.bgColor(style_1.commonStyles.whiteColor)])} scrollY onScroll={(e) => {
          ...
          <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.bgColor(style_1.commonStyles.whiteColor)])}>
            <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100)])}>
              <index_3.default style={datatool_1.styleAssign([style_1.wRatio(100), style_1.h(182)])}/>
            </components_1.View>
            ...
            <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.default.uac, style_1.default.upa, style_1.absT(120)])}>
              ...
              {userInfo.enterpriseName && <components_1.Text style={datatool_1.styleAssign([style_1.fSize(16), style_1.color('#727272'), style_1.mt(4)])}>{`${userInfo.enterpriseName}-${userInfo.position}`}</components_1.Text>}
              {userInfo.school.length !== 0 && <components_1.Text style={datatool_1.styleAssign([style_1.fSize(14), style_1.color('#727272'), style_1.mt(4)])}>{`${userInfo.school}•${userInfo.profession}`}</components_1.Text>}
          ...
          <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.h(101), style_1.bgColor(style_1.commonStyles.whiteColor), style_1.mt(10),])}>
            ...
            <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.h(50), style_1.default.ujc])}>
              <index_3.default style={datatool_1.styleAssign([style_1.wRatio(90), style_1.h(20), { marginLeft: '5%' }])}/>
          ...
          <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100)])}>
            <index_2.default customStyle={datatool_1.styleAssign([style_1.wRatio(100), style_1.h(40), style_1.mt(10), style_1.default.ujb, style_1.default.uac, style_1.default.udr, style_1.bgColor(style_1.commonStyles.whiteColor)])} onClick={() => {
            ...
            <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100)])}>
                ...
                taro_1.default.navigateTo({
                  ...
                  <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.h(38), style_1.default.udr, style_1.default.uac, style_1.default.ujb])}>
                    ...
                    <index_2.default customStyle={datatool_1.styleAssign([style_1.default.uac, style_1.default.udr, style_1.mr(20)])}>
                ...
                taro_1.default.navigateTo({
                  ...
                  <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.mb(10), style_1.default.uac, style_1.pl(20), style_1.pr(20)])}>
                    {userInfo.selfDescription && userInfo.selfDescription.length !== 0 ?
                <multi_line_text_1.default style={datatool_1.styleAssign([style_1.fSize(12), style_1.color('#0C0C0C')])} text={userInfo.selfDescription}/> :
                ...
                taro_1.default.navigateTo({
                  ...
                  <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.h(38), style_1.default.udr, style_1.default.uac, style_1.default.ujb])}>
                    ...
                    <index_2.default customStyle={datatool_1.styleAssign([style_1.default.uac, style_1.default.udr, style_1.mr(20)])}>
                      <components_1.Text style={datatool_1.styleAssign([style_1.fSize(12), style_1.color('#A9A9A9')])}>{userInfo.hometownProvince || userInfo.hometownCity ? '编辑' : '添加'}</components_1.Text>
                      <components_1.Image style={datatool_1.styleAssign([style_1.w(7), style_1.h(12), style_1.ml(6)])} src={`${httpurl_1.cloudBaseUrl}ico_next.png`}/>
                    </index_2.default>
                  </components_1.View>
          ...
          <index_2.default customStyle={datatool_1.styleAssign([style_1.wRatio(100), style_1.mt(10), style_1.default.uac, style_1.bgColor(style_1.commonStyles.whiteColor)])} onClick={() => {
            taro_1.default.navigateTo({
          ...
          <index_2.default customStyle={datatool_1.styleAssign([style_1.wRatio(100), style_1.h(264), style_1.mt(10), style_1.default.uac, style_1.bgColor(style_1.commonStyles.whiteColor)])} onClick={() => {
            taro_1.default.navigateTo({
          ...
          <index_2.default customStyle={datatool_1.styleAssign([style_1.wRatio(100), style_1.h(80), style_1.mt(10), style_1.bgColor(style_1.commonStyles.whiteColor), style_1.default.uac, style_1.default.ujc,
            ...
            <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.default.uac, style_1.default.ujb, style_1.default.udr])}>
              ...
              <index_2.default customStyle={datatool_1.styleAssign([style_1.default.uac, style_1.default.udr])}>
                <components_1.Text style={datatool_1.styleAssign([style_1.fSize(12), style_1.color('#A9A9A9')])}>编辑</components_1.Text>
                <components_1.Image style={datatool_1.styleAssign([style_1.w(7), style_1.h(12), style_1.ml(6)])} src={`${httpurl_1.cloudBaseUrl}ico_next.png`}/>
              </index_2.default>
            </components_1.View>
        ...
        <index_4.default style={datatool_1.styleAssign([style_1.default.upa, style_1.absT(0), style_1.op((300 - scrollTop) / 300)])}>
