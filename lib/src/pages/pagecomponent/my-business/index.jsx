        ...
        <components_1.View style={datatool_1.styleAssign([{ width: '95%' }, { marginLeft: '2.5%' }, style_1.mt(16), style_1.h(270), style_1.bgColor(style_1.commonStyles.whiteColor)])}>
          ...
          {userInfo.enterpriseVideo.length !== 0 &&
            <components_1.View style={datatool_1.styleAssign([style_1.default.uf1, style_1.default.uac, style_1.default.ujc])}>
              <components_1.Video style={datatool_1.styleAssign([style_1.wRatio(90), style_1.hRatio(90), style_1.bgColor(style_1.commonStyles.whiteColor)])} src={userInfo.enterpriseVideo} autoplay={false} objectFit={'fill'} poster='https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3466612495,3967902081&fm=26&gp=0.jpg' initialTime={1} id='video' loop={false} muted={false} showPlayBtn={true} showProgress={true}/>
            </components_1.View>}
        </components_1.View>
      </components_1.View>);
    }
