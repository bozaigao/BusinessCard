...
class LeiDaGuide extends taro_1.PureComponent {
    render() {
        ...
        <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.h(174), style_1.default.uac, style_1.default.upa, style_1.absB(0)])}>
          <components_1.Text style={datatool_1.styleAssign([style_1.w(216), style_1.h(50), style_1.fSize(18), style_1.color(style_1.commonStyles.whiteColor)])}>完善名片后可在雷达查看所有客户及访客的行为轨迹哦！</components_1.Text>
