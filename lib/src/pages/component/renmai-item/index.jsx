    ...
    render() {
        ...
        <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.h(112), style_1.default.udr, style_1.default.uac, style_1.default.ujb, style_1.bgColor(style_1.commonStyles.whiteColor)])}>
          <components_1.View style={datatool_1.styleAssign([style_1.default.uac, style_1.default.udr, style_1.ml(20)])}>
            <components_1.Image style={datatool_1.styleAssign([style_1.w(66), style_1.h(66), style_1.radiusA(33)])} src={item.avatar} mode={'aspectFit'}/>
            <components_1.View style={datatool_1.styleAssign([style_1.ml(22)])}>
              <singleline_text_1.default style={datatool_1.styleAssign([style_1.fSize(16), style_1.w(140), style_1.color('#343434')])} text={item.name}/>
          ...
          {item.type === 1 && <components_1.View style={datatool_1.styleAssign([style_1.w(64), style_1.h(28), style_1.radiusA(2), style_1.bgColor(style_1.commonStyles.colorTheme), style_1.default.uac, style_1.default.ujc, style_1.mr(20)])}>
