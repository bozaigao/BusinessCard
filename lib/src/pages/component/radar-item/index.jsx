...
class RadarItem extends taro_1.PureComponent {
    render() {
        ...
        return (<index_1.default customStyle={datatool_1.styleAssign([style_1.radiusA(4), { width: '95%' }, { marginLeft: '2.5%' }, style_1.h(175), style_1.bgColor(style_1.commonStyles.whiteColor), style_1.mt(14)])}>
        ...
        <components_1.View style={datatool_1.styleAssign([style_1.default.uac, style_1.default.udr, style_1.mt(3)])}>
          <components_1.Text style={datatool_1.styleAssign([style_1.fSize(14), style_1.ml(16), style_1.color(style_1.commonStyles.colorTheme)])}>在您的名片停留了</components_1.Text>
        ...
        <components_1.View style={datatool_1.styleAssign([style_1.default.uf1, style_1.default.ujb, style_1.default.udr])}>
          <components_1.View style={datatool_1.styleAssign([style_1.hRatio(100), style_1.default.uac, style_1.default.ujc])}>
            <components_1.Text style={datatool_1.styleAssign([style_1.color('#979797'), style_1.fSize(13), style_1.ml(16)])}>{`最后访问 ${datatool_1.transformTime(item.lastVisitTime)}`}</components_1.Text>
          </components_1.View>
          <components_1.View style={datatool_1.styleAssign([style_1.default.uac, style_1.default.udr])}>
