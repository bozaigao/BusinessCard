...
const index_2 = require("./component/radar-item/index");
...
const leida_guide_1 = require("./component/leida-guide");
const httpurl_1 = require("../api/httpurl");
let Radar = class Radar extends taro_1.Component {
    constructor(props) {
        super(props);
        /**
        ...
        {records.length === 0 ?
            ...
            <components_1.ScrollView style={datatool_1.styleAssign([style_1.default.uf1, style_1.default.uac, style_1.bgColor(style_1.commonStyles.pageDefaultBackgroundColor)])} scrollY onScrollToUpper={() => {
              ...
              {records.map((value, index) => {
                console.log(value);
                return (<index_2.default key={index} item={value} collectCallback={(userId) => {
...
Radar = __decorate([
    redux_1.connect(state => Object.assign(state.taskCenter, state.login), Object.assign(customerActions, actions, businessCardActions))
], Radar);
