...
function padding(paddingArr) {
    ...
    datatool_1.toast('padding方法第一个参数为数组,四个参数的时候分别代表上右下左,也可以传递3,2,1个参数');
    return {};
}
...
function border(borderWidthArr) {
    ...
    datatool_1.toast('border方法第一个参数为数组,四个参数的时候分别代表上右下ø左,也可以传递3,2,1个参数');
    return {};
}
...
function margin(marginArr) {
    ...
    datatool_1.toast('radius方法中第一个数组参数必须为四个元素,默认左上为第一个参数,顺时针旋转');
    return {};
}
...
function abs(absolutePositionArr) {
    ...
    datatool_1.toast('abs方法第一个参数为数组,四个参数的时候分别代表上右下左,也可以传递3,2,1个参数');
    return {};
}
exports.abs = abs;
/*字体大小*/
...
exports.commonStyles = {
    ...
    yellowColor2: '#fad41b',
    //页面默认底色
    pageDefaultBackgroundColor: '#F7F7F7',
    whiteColor: '#FFFFFF',
    blackColor: '#000000',
    //主题字黑色
