 ...
 */
exports.interestBehaviorActive = payload => redux_1.createAction({
    url: httpurl_1.RadarManage.interestBehaviorActive,
    payload,
    method: 'GET'
});
/**
 ...
 * @function: 查询雷达客户详情资料
*/
exports.getBehaviorTrace = payload => redux_1.createAction({
    url: httpurl_1.RadarManage.getBehaviorTrace,
    payload,
    method: 'GET'
});
