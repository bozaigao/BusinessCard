 ...
 */
exports.getAccessToken = payload => redux_1.createAction({
    url: httpurl_1.UserController.getAccessToken,
    payload,
    method: 'GET',
});
/**
 ...
 * @function: 获取小程序二维码
 */
exports.getWXacode = payload => redux_1.createAction({
    url: `${httpurl_1.UserController.getWXacode}?access_token=${payload.access_token}`,
    payload,
    method: 'POST',
});
