 ...
 * @function: 查询用户访客和收藏数
*/
exports.getCardHolderVisitorCount = payload => redux_1.createAction({
    url: httpurl_1.UserController.getCardHolderVisitorCount,
    payload,
    method: 'GET',
});
/**
 ...
 */
exports.getCardHolderVisitorRecord = payload => redux_1.createAction({
    url: httpurl_1.UserController.getCardHolderVisitorRecord,
    payload,
    method: 'GET',
});
/**
...
*/
exports.userSettingUpdate = payload => redux_1.createAction({
    url: httpurl_1.UserController.userSettingUpdate,
    payload,
    method: 'POST'
});
/**
 ...
 * @function: 获取用户的设置信息
 */
exports.userSettingGet = payload => redux_1.createAction({
    url: httpurl_1.UserController.userSettingGet,
    payload,
    method: 'GET'
});
/**
 ...
 * @function:  获取公司推荐名片
*/
exports.getCompanyCard = payload => redux_1.createAction({
    url: httpurl_1.UserController.getCompanyCard,
    payload,
    method: 'GET'
});
