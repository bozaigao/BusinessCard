...
class CardStyle4 extends taro_1.PureComponent {
    render() {
        ...
        <components_1.Image style={datatool_1.styleAssign([style_1.wRatio(100), style_1.h(204), style_1.default.upa, style_1.absT(0)])} src={require('../../assets/ico_business_card_bg4.png')}/>
        <components_1.View style={datatool_1.styleAssign([style_1.wRatio(100), style_1.h(204), style_1.default.upa, style_1.absT(0)])}>
          <components_1.Image style={datatool_1.styleAssign([style_1.w(60), style_1.h(60), style_1.radiusA(30), style_1.default.upa, style_1.absT(20), style_1.absR(24)])} src={userInfo.avatar}/>
          ...
          <components_1.View style={datatool_1.styleAssign([style_1.default.upa, style_1.absL(30), style_1.absT(39)])}>
            ...
            <components_1.Text style={datatool_1.styleAssign([style_1.fSize(11), style_1.color('#343434'), style_1.mt(2)])}>{userInfo.enterpriseName}</components_1.Text>
          </components_1.View>
          <components_1.View style={datatool_1.styleAssign([style_1.default.upa, style_1.absB(26), style_1.absL(30)])}>
            ...
            {!hideAddress && <components_1.View style={datatool_1.styleAssign([style_1.default.udr, style_1.default.uac, style_1.mt(8)])}>
                <components_1.Image style={datatool_1.styleAssign([style_1.w(9), style_1.h(11)])} src={require('../../assets/ico_card_location_gray.png')}/>
