          ...
          <View style={styleAssign([wRatio(100), h(204), bgColor(commonStyles.whiteColor), styles.uac, mt(20)])}>
            ...
            <View
              ...
              <View style={styleAssign([wRatio(100), styles.udr, styles.uac])}>
                <View
                  style={styleAssign([styles.uf1, radiusA(4), styles.uac, styles.ujc, bo(5), bdColor(commonStyles.colorTheme),
                ...
                <View style={styleAssign([styles.uf1, radiusA(4), ml(15), styles.uac, styles.ujc, bo(1), h(44),
                  bdColor(commonStyles.colorTheme), bgColor(commonStyles.blackColor), bo(5), bdColor('red')])}>
