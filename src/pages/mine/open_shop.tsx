      ...
      <CustomSafeAreaView ref={(ref) => {
        ...
        <ScrollView
          ...
          <View style={styleAssign([styles.uf1, pl(20), pr(20)])}>
            ...
            <Text
              style={styleAssign([color('#727272'), fSize(14), mt(13)])}>打开极易推，进入名片“我的”页面，选择“我的店铺”，点击“立即开通”，进入“开通申请”页面，提交申请之后，工作人员会在12小时内联系用户，相关事宜会由工作人员与用户沟通，开通成功之后，即可使用商铺程序。</Text>
          ...
          <View style={styleAssign([styles.uf1, pl(20), pr(20)])}>
            ...
            <Text
              style={styleAssign([color('#727272'), fSize(14), mt(13)])}>打开极易推，进入名片“我的”页面，点击“开通特权”，进入“特权开通”页面，了解特权详情及开通套餐之后，点击“立即开通”，进入“开通申请”页面，提交申请之后，工作人员会在12小时内联系用户，相关事宜会由工作人员与用户沟通，开通成功之后，即可使用商铺程序。</Text>
            <View style={styleAssign([wRatio(100), styles.udr, styles.uac, styles.ujb, mt(17)])}>
