      ...
      <CustomSafeAreaView ref={(ref) => {
        ...
        <ScrollView
          ...
          <View style={styleAssign([styles.uf1, pl(20), pr(20)])}>
            ...
            <Text
              style={styleAssign([color('#727272'), fSize(14), mt(13)])}>打开极易推，进入名片首页，在人脉机遇版块点击“立即选择”，进入“选择人脉”页面，选择好了之后，后台会通过用户的人脉选择内容为用户推送相关人脉。使人脉推送更精准有效。</Text>
          ...
          <View style={styleAssign([styles.uf1, pl(20), pr(20)])}>
            ...
            <Text
              style={styleAssign([color('#727272'), fSize(14), mt(13)])}>打开极易推，进入名片首页，在人脉机遇版块除了推荐一栏需要用户选择期望人脉以外，其他栏内容则是通过用户完善名片信息之后，后台通过用户名片信息进行人脉匹配推送。</Text>
            <View style={styleAssign([wRatio(100), styles.udr, styles.uac, styles.ujb, mt(17)])}>
